...
export class Backend implements backendInterface {
    ...
    async changeAvatarColor(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.changeAvatarColor(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecentMessages(): Promise<Array<ChatMessage>> {
        if (this.processError) {
            try {
    ...
    async getUserGameHistory(): Promise<Array<GameResult>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserGameHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordGameResult(arg0: GameResult): Promise<void> {
        if (this.processError) {
            try {
